...
class LSTM_architecture(nn.Module):
    def __init__(self, vocab_size, output_size, embedding_dim, hidden_dim, number_of_layers, drop=0.5):
        ...
        self.dangerous_words = ["террорист", "фейк", "саботаж", "бомба", "взрыв", "убийство", "насилие", "атака", "угроза", "опасность", "террор"]  # Расширенный список опасных слов
    ...
    def detect_dangerous_words(self, text):
        dangerous_words_found = [word for word in self.dangerous_words if word in text]
        return dangerous_words_found
